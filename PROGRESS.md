...
> Snapshot: `2026-05-20` @ [`d3cddebfe`](https://github.com/Verified-zkEVM/evm-asm/commit/d3cddebfeb7d52bd884e4fa4e1091aba80bfbecd)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **19**
- ziskemu round-trip scripts: **18** under `scripts/codegen-*.sh`
