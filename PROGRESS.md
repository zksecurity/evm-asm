...
> Snapshot: `2026-05-21` @ [`ecbbbb0be`](https://github.com/Verified-zkEVM/evm-asm/commit/ecbbbb0be9d4913de7f2cb4123dd53210c70c54d)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **48**
- ziskemu round-trip scripts: **43** under `scripts/codegen-*.sh`
