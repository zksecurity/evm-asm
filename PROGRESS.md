...
> Snapshot: `2026-05-20` @ [`505297d2c`](https://github.com/Verified-zkEVM/evm-asm/commit/505297d2c772be73bbc189c0aaf21384cba69702)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **20**
- ziskemu round-trip scripts: **19** under `scripts/codegen-*.sh`
