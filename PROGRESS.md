...
> Snapshot: `2026-05-21` @ [`5df5993b9`](https://github.com/Verified-zkEVM/evm-asm/commit/5df5993b9b899e6af008837a9ba9dca7e7211be4)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **41**
- ziskemu round-trip scripts: **36** under `scripts/codegen-*.sh`
