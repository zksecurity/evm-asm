...
> Snapshot: `2026-05-20` @ [`a2cb9c961`](https://github.com/Verified-zkEVM/evm-asm/commit/a2cb9c9613eba7243828a0531726367738041167)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **37**
- ziskemu round-trip scripts: **30** under `scripts/codegen-*.sh`
