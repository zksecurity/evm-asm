...
> Snapshot: `2026-05-20` @ [`d0e07184d`](https://github.com/Verified-zkEVM/evm-asm/commit/d0e07184df060d33095d51325ac11d57cade47da)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **17**
- ziskemu round-trip scripts: **15** under `scripts/codegen-*.sh`
