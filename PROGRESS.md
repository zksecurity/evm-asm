...
> Snapshot: `2026-05-19` @ [`cf29496a0`](https://github.com/Verified-zkEVM/evm-asm/commit/cf29496a0f6eaa75be6bfef535dbedf68c1144f2)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **8**
- ziskemu round-trip scripts: **5** under `scripts/codegen-*.sh`
