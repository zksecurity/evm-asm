...
> Snapshot: `2026-05-21` @ [`d8d7df6f2`](https://github.com/Verified-zkEVM/evm-asm/commit/d8d7df6f29846ac1d7bccca069b6f7a922b80f2a)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **50**
- ziskemu round-trip scripts: **45** under `scripts/codegen-*.sh`
