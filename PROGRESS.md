...
> Snapshot: `2026-05-21` @ [`b3e0f2b34`](https://github.com/Verified-zkEVM/evm-asm/commit/b3e0f2b34140dcda0d9032c4176e537330e0a26e)
...
- Programs in `EvmAsm/Codegen/Programs.lean` registry: **46**
- ziskemu round-trip scripts: **41** under `scripts/codegen-*.sh`
