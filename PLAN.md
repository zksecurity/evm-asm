...
**Done (14 opcodes with full 256-bit specs):**
- Arithmetic: ADD, SUB
- Bitwise: AND, OR, XOR, NOT
- Comparison: ISZERO, LT, GT, EQ
- Stack: POP, PUSH0, DUP1, SWAP1
...
1. Phase 1: EQ (complete basic comparisons) — **done**
2. Phase 2.1-2.4: POP, PUSH0, DUP1, SWAP1 — **done**
