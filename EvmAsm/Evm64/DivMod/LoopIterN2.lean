...
theorem loopBodyN2MaxSkipJ0Pre_unfold
    ...
    (let uBase := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
     ...
     ((uBase + signExtend12 4064) ↦ₘ uTop) **
     (qAddr ↦ₘ qOld)) := by
  delta loopBodyN2MaxSkipJ0Pre; rfl
...
/-- No-NOP variant of `divK_loop_body_n2_max_skip_j0_spec_within`. -/
theorem divK_loop_body_n2_max_skip_j0_spec_within_noNop
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
    (hbltu : ¬BitVec.ult u2 v1) :
  ...
  let u4_new := uTop - c3
  let vtopBase := sp + ((2 : Word) + signExtend12 4095) <<< (3 : BitVec 6).toNat
  have TF := divK_trial_max_full_spec_within_noNop sp (0 : Word) (2 : Word) jOld v5Old v6Old v7Old v10Old v11Old
    u2 u1 v1 base hbltu
  dsimp only [] at TF
  rw [u_addr_eq_n2] at TF
  rw [u_addr8_eq_n2] at TF
...
/-- No-NOP variant of `divK_loop_body_n2_call_skip_j0_spec_within`. -/
theorem divK_loop_body_n2_call_skip_j0_spec_within_noNop
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (retMem dMem dloMem scratch_un0 : Word)
    (base : Word)
  ...
  unfold isSkipBorrowN2Call div128Quot at hborrow
  let vtopBase := sp + ((2 : Word) + signExtend12 4095) <<< (3 : BitVec 6).toNat
  have TF := divK_trial_call_full_spec_within_noNop sp (0 : Word) (2 : Word) jOld v5Old v6Old v7Old v10Old v11Old v2Old
    u2 u1 v1 retMem dMem dloMem scratch_un0 base
    halign hbltu
  unfold divKTrialCallFullPost at TF
  dsimp only [] at TF
...
/-- No-NOP variant of `divK_loop_body_n2_max_skip_jgt0_spec_within`. -/
theorem divK_loop_body_n2_max_skip_jgt0_spec_within_noNop (j : Word)
    (hpos : BitVec.slt (j + signExtend12 4095) 0 = false)
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
  ...
  let u4_new := uTop - c3
  let vtopBase := sp + ((2 : Word) + signExtend12 4095) <<< (3 : BitVec 6).toNat
  have TF := divK_trial_max_full_spec_within_noNop sp j (2 : Word) jOld v5Old v6Old v7Old v10Old v11Old
    u2 u1 v1 base hbltu
  dsimp only [] at TF
  rw [u_addr_eq_n2] at TF
  rw [u_addr8_eq_n2] at TF
...
/-- No-NOP variant of `divK_loop_body_n2_call_skip_jgt0_spec_within`. -/
theorem divK_loop_body_n2_call_skip_jgt0_spec_within_noNop (j : Word)
    (hpos : BitVec.slt (j + signExtend12 4095) 0 = false)
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (retMem dMem dloMem scratch_un0 : Word)
  ...
  unfold isSkipBorrowN2Call div128Quot at hborrow
  let vtopBase := sp + ((2 : Word) + signExtend12 4095) <<< (3 : BitVec 6).toNat
  have TF := divK_trial_call_full_spec_within_noNop sp j (2 : Word) jOld v5Old v6Old v7Old v10Old v11Old v2Old
    u2 u1 v1 retMem dMem dloMem scratch_un0 base
    halign hbltu
  unfold divKTrialCallFullPost at TF
  dsimp only [] at TF
...
/-- No-NOP variant of `divK_loop_body_n2_max_addback_j0_beq_spec_within`. -/
theorem divK_loop_body_n2_max_addback_j0_beq_spec_within_noNop
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
    (hbltu : ¬BitVec.ult u2 v1)
