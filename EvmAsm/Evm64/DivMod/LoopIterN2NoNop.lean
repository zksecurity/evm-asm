...
/-- No-NOP variant of `divK_loop_body_n2_call_addback_j0_beq_spec_within`. -/
theorem divK_loop_body_n2_call_addback_j0_beq_spec_within_noNop
...
/-- No-NOP variant of `divK_loop_body_n2_max_addback_jgt0_beq_spec_within`. -/
theorem divK_loop_body_n2_max_addback_jgt0_beq_spec_within_noNop (j : Word)
  ...
  rw [u_addr8_eq_n2] at TF
  rw [vtop_eq_v1_n2] at TF
  have MCA := divK_mulsub_correction_addback_beq_spec_within_noNop sp qHat j v0 v1 v2 v3 u0 u1 u2 u3 uTop
...
/-- No-NOP variant of `divK_loop_body_n2_call_addback_jgt0_beq_spec_within`. -/
theorem divK_loop_body_n2_call_addback_jgt0_beq_spec_within_noNop (j : Word)
    (hpos : BitVec.slt (j + signExtend12 4095) 0 = false)
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (retMem dMem dloMem scratch_un0 : Word)
