/-
  EvmAsm.Evm64.DivMod.Spec.CallSkipNoNop
...
/-- No-NOP variant of `evm_div_n4_full_shift0_call_skip_stack_pre_spec`. -/
theorem evm_div_n4_full_shift0_call_skip_stack_pre_spec_noNop (sp base : Word)
  ...
  have hraw := evm_div_n4_full_shift0_call_skip_spec_noNop sp base
    (a.getLimbN 0) (a.getLimbN 1) (a.getLimbN 2) (a.getLimbN 3)
...
/-- Bundled no-NOP variant of `evm_div_n4_full_shift0_call_skip_stack_pre_spec_bundled`. -/
theorem evm_div_n4_full_shift0_call_skip_stack_pre_spec_bundled_noNop (sp base : Word)
    ...
    cpsTripleWithin (8 + 21 + 24 + 4 + 9 + 4 + 126 + 12)
      ...
      (fullDivN4Shift0CallSkipPost sp base
        (a.getLimbN 0) (a.getLimbN 1) (a.getLimbN 2) (a.getLimbN 3)
        (b.getLimbN 0) (b.getLimbN 1) (b.getLimbN 2) (b.getLimbN 3)) := by
  have h := evm_div_n4_full_shift0_call_skip_stack_pre_spec_noNop sp base a b
