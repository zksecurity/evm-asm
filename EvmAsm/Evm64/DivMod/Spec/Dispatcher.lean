...
/-- n=2 mirror of `fullDivN1QuotientWord`. The n=2 algorithm produces only
three nontrivial quotient limbs (r0.1, r1.1, r2.1); the top limb is always
zero, since the divisor is at least 2^64 (the relevant CLZ witness is on
`b1`, not `b0`). -/
@[irreducible]
