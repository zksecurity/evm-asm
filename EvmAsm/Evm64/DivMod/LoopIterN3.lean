...
theorem loopBodyN3CallSkipJ0Pre_unfold
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (retMem dMem dloMem scratchUn0 : Word) :
    loopBodyN3CallSkipJ0Pre sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
  ...
  delta loopBodyN3CallSkipJ0Pre; rfl
...
theorem divK_loop_body_n3_call_skip_j0_spec_within
  ...
  exact cpsTripleWithin_weaken
    (fun h hp => by rw [loopBodyN3CallSkipJ0Pre_unfold] at hp; xperm_hyp hp)
    (fun h hp => by
