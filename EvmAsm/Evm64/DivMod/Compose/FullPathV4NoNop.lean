...
/-- DIV PhaseAB(n=1) + CLZ + PhaseC2(ntaken) over `divCode_noNop_v4`.
    This is the shift≠0 prefix that reaches NormB. -/
theorem evm_div_phaseAB_n1_clz_c2_spec_v4_noNop (sp base : Word)
    (b0 b1 b2 b3 v5 v6 v7 v10 : Word)
    (q0 q1 q2 q3 u5 u6 u7 nMem shiftMem : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0)
    (hb3z : b3 = 0) (hb2z : b2 = 0) (hb1z : b1 = 0)
    (hshift_nz : (clzResult b0).1 ≠ 0) :
    cpsTripleWithin (8 + 21 + 24 + 4) base (base + normBOff) (divCode_noNop_v4 base)
      ((.x12 ↦ᵣ sp) ** (.x5 ↦ᵣ v5) ** (.x10 ↦ᵣ v10) ** (.x0 ↦ᵣ (0 : Word)) **
  ...
  have hABCLZ := evm_div_phaseAB_n1_clz_spec_v4_noNop sp base b0 b1 b2 b3
  ...
  have hABCLZf := cpsTripleWithin_frameR
    ...
    (by pcFree) hABCLZ
  have hC2 := divK_phaseC2_ntaken_spec_within_v4_noNop sp (clzResult b0).1
