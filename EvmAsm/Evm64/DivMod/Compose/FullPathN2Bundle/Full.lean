...
theorem evm_div_n2_full_unified_spec
    ...
    cpsTripleWithin 744 base (base + nopOff) (divCode base)
      ...
      (fullDivN2UnifiedPost bltu_2 bltu_1 bltu_0 sp base
        a0 a1 a2 a3 b0 b1 b2 b3 retMem dMem dloMem scratch_un0) := by
  exact cpsTripleWithin_weaken
    (fun _ hp => hp)
    (fun h hq => by
      delta fullDivN2UnifiedPost
      xperm_hyp hq)
    (evm_div_n2_full_bundled_spec bltu_2 bltu_1 bltu_0 sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      retMem dMem dloMem scratch_un0
      hbnz hb3z hb2z hb1nz hshift_nz halign hbltu_2 hbltu_1 hbltu_0 hcarry2)
...
theorem evm_div_n2_full_bundled_spec_noNop
  ...
  have hshift_nz' : fullDivN2Shift b1 ≠ 0 := by
    rw [fullDivN2Shift_unfold]
    exact hshift_nz
  have hA := evm_div_n2_preloop_loop_unified_spec_noNop bltu_2 bltu_1 bltu_0 sp base
    a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
    q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
    retMem dMem dloMem scratch_un0
    hbnz hb3z hb2z hb1nz hshift_nz halign hbltu_2 hbltu_1 hbltu_0 hcarry2
  have hB := evm_div_n2_denorm_epilogue_bundled_spec_noNop bltu_2 bltu_1 bltu_0
    sp base a0 a1 a2 a3 b0 b1 b2 b3 hshift_nz'
  have hBF := cpsTripleWithin_frameR
    (fullDivN2Frame bltu_2 bltu_1 bltu_0 sp base a0 a1 a2 a3 b0 b1 b2 b3
      retMem dMem dloMem scratch_un0)
...
theorem evm_div_n2_full_unified_spec_noNop
  ...
  exact cpsTripleWithin_weaken
    ...
    (fun h hq => by
      delta fullDivN2UnifiedPost
      xperm_hyp hq)
    (evm_div_n2_full_bundled_spec_noNop bltu_2 bltu_1 bltu_0 sp base
      a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old
      q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem
      retMem dMem dloMem scratch_un0
      hbnz hb3z hb2z hb1nz hshift_nz halign hbltu_2 hbltu_1 hbltu_0 hcarry2)
