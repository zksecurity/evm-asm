...
/-- No-NOP variant of `divK_loop_body_n4_call_addback_j0_beq_norm`. -/
theorem divK_loop_body_n4_call_addback_j0_beq_norm_noNop (sp base : Word)
    (jOld v5Old v6Old v7Old v10Old v11Old v2Old : Word)
    (v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (retMem dMem dloMem scratch_un0 : Word)
    (halign : ((base + div128CallRetOff) + signExtend12 (0 : BitVec 12)) &&& ~~~(1 : Word) = base + div128CallRetOff)
...
theorem evm_div_n4_preloop_call_addback_beq_spec_noNop (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratch_un0 : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0) (hb3nz : b3 ≠ 0)
...
theorem evm_div_n4_call_addback_beq_denorm_epilogue_spec_noNop (sp base : Word)
  ...
  exact cpsTripleWithin_weaken
    (fun h hp => by
      simp only [preloopCallAddbackBeqPostN4_unfold] at hp
      xperm_hyp hp)
    (fun h hq => by
      delta fullDivN4CallAddbackBeqPost
      rw [sepConj_assoc'] at hq
      xperm_hyp hq)
    hBF

/-- No-NOP variant of `evm_div_n4_full_call_addback_beq_spec`. -/
theorem evm_div_n4_full_call_addback_beq_spec_noNop (sp base : Word)
    (a0 a1 a2 a3 b0 b1 b2 b3 v5 v6 v7 v10 v11Old : Word)
    (q0 q1 q2 q3 u0Old u1Old u2Old u3Old u4Old u5 u6 u7 nMem shiftMem jMem : Word)
    (retMem dMem dloMem scratch_un0 : Word)
    (hbnz : b0 ||| b1 ||| b2 ||| b3 ≠ 0) (hb3nz : b3 ≠ 0)
  ...
  have hA := evm_div_n4_preloop_call_addback_beq_spec_noNop sp base
    ...
    hbnz hb3nz hshift_nz
    halign hbltu hcarry2_nz hborrow
  have hB := evm_div_n4_call_addback_beq_denorm_epilogue_spec_noNop sp base
