/-
  EvmAsm.Evm64.DivMod.LoopBodyN1Concrete

  Concrete (non-existential) loop body postcondition for n=1 at j=0.
...
-- n=1: BLTU checks u1 < v0, div128 uses (v0, u0, u1)
-- ============================================================================

set_option maxRecDepth 8192 in
set_option maxHeartbeats 12800000 in
/-- Concrete loop body for n=1, j=0, MAX+SKIP case (BLTU not taken, borrow=0).
    Postcondition uses mulsubN4 outputs directly — no existentials. -/
theorem divK_loop_body_n1_j0_max_skip_concrete
    ...
    cpsTriple (base + 448) (base + 904) (sharedDivModCode base)
      ...
      (fun h => loopBodyPostN1 sp (0 : Word) v0 v1 v2 v3
  ...
  exact cpsTriple_consequence _ _ _ _ _ _ _
    ...
    (fun h hp => by unfold loopBodyPostN1; xperm_hyp hp)
    fullf

set_option maxRecDepth 8192 in
set_option maxHeartbeats 12800000 in
/-- Concrete loop body for n=1, j=0, MAX+ADDBACK case (BLTU not taken, borrow≠0).
    Postcondition uses addbackN4 outputs directly — no existentials. -/
theorem divK_loop_body_n1_j0_max_addback_concrete
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old : Word)
    (ret_mem d_mem dlo_mem scratch_un0 : Word)
    (base : Word)
...
set_option maxRecDepth 8192 in
set_option maxHeartbeats 12800000 in
/-- Concrete loop body for n=1, j=0, CALL+SKIP case (BLTU taken, borrow=0).
    Postcondition uses mulsubN4 outputs directly — no existentials.
    Scratch memory (ret, d, dlo, un0) updated to div128 values. -/
theorem divK_loop_body_n1_j0_call_skip_concrete
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old : Word)
    (ret_mem d_mem dlo_mem scratch_un0 : Word)
    (base : Word)
    ...
    let u_base := sp + signExtend12 4056 - (0 : Word) <<< (3 : BitVec 6).toNat
    let q_addr := sp + signExtend12 4088 - (0 : Word) <<< (3 : BitVec 6).toNat
    -- div128 intermediates for q_hat (using v0 as divisor top, u0/u1 as dividend)
...
set_option maxRecDepth 8192 in
set_option maxHeartbeats 12800000 in
/-- Concrete loop body for n=1, j=0, CALL+ADDBACK case (BLTU taken, borrow≠0).
    Postcondition uses addbackN4 outputs directly — no existentials.
    Scratch memory (ret, d, dlo, un0) updated to div128 values. -/
theorem divK_loop_body_n1_j0_call_addback_concrete
    (sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
     v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old : Word)
    (ret_mem d_mem dlo_mem scratch_un0 : Word)
    (base : Word)
