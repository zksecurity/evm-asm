/-
  EvmAsm.Evm64.DivMod.LoopIterN3MaxV4NoNop
...
/-- No-NOP/v4 variant of `divK_loop_body_n3_max_skip_j0_spec_within_noNop`. -/
theorem divK_loop_body_n3_max_skip_j0_v4_spec_within_noNop
  ...
  exact cpsTripleWithin_weaken
    ...
    (fun h hp => by
      delta loopBodyN3SkipPost loopBodySkipPost mulsubN4 loopExitPostN3 loopExitPost
      rw [sepConj_assoc'] at hp
      xperm_hyp hp)
    full

/-- No-NOP/v4 variant of `divK_loop_body_n3_max_skip_j1_spec_within_noNop`. -/
theorem divK_loop_body_n3_max_skip_j1_v4_spec_within_noNop
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
    (hbltu : ¬BitVec.ult u3 v2) :
  ...
  let u4_new := uTop - c3
  let vtopBase := sp + ((3 : Word) + signExtend12 4095) <<< (3 : BitVec 6).toNat
  have TF := divK_trial_max_full_v4_spec_within_noNop sp (1 : Word) (3 : Word)
    jOld v5Old v6Old v7Old v10Old v11Old u3 u2 v2 base hbltu
  dsimp only [] at TF
  rw [u_addr_eq_n3] at TF
  rw [u_addr8_eq_n3] at TF
