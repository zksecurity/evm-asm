...
/-- No-NOP variant of `divK_loop_body_n1_max_skip_j0_spec_within`. -/
theorem divK_loop_body_n1_max_skip_j0_spec_within_noNop
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
    (hbltu : ¬BitVec.ult u1 v0) :
  ...
  exact cpsTripleWithin_weaken
    (fun h hp => by xperm_hyp hp)
    (fun h hp => by
      delta loopBodyN1SkipPost loopBodySkipPost mulsubN4 loopExitPostN1 loopExitPost
      rw [sepConj_assoc'] at hp
      xperm_hyp hp)
    full

/-- No-NOP variant of `divK_loop_body_n1_max_skip_jgt0_spec_within`. -/
theorem divK_loop_body_n1_max_skip_jgt0_spec_within_noNop (j : Word)
    (hpos : BitVec.slt (j + signExtend12 4095) 0 = false)
    (sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
     v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld : Word)
    (base : Word)
