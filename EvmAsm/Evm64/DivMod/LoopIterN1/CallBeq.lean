...
/-- Compatibility wrapper for the unbounded n=1 call+addback BEQ j=0 surface. -/
theorem divK_loop_body_n1_call_addback_j0_beq_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      ...
      (loopBodyN1CallAddbackBeqPostJ sp base (0 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  intro uBase qAddr
  exact (divK_loop_body_n1_call_addback_j0_beq_spec_within
    sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
    v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld
    retMem dMem dloMem scratch_un0 base halign hbltu hborrow hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n1_call_addback_jgt0_beq_spec (j : Word)
    ...
    cpsTriple (base + loopBodyOff) (base + loopBodyOff) (sharedDivModCode base)
      ...
      (loopBodyN1CallAddbackBeqPostJ sp base j v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  intro uBase qAddr
  exact (divK_loop_body_n1_call_addback_jgt0_beq_spec_within j hpos
    sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
    v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld
    retMem dMem dloMem scratch_un0 base halign hbltu hborrow hcarry2_nz).to_cpsTriple
