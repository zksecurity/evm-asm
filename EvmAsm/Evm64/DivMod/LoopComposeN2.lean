...
theorem divK_loop_body_n2_iter_spec_within (j : Fin 3) (bltu : Bool)
  ...
  · -- false (max)
    ...
    fin_cases j
    · exact divK_loop_body_n2_max_unified_j0_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old base hbltu hcarry
    · exact divK_loop_body_n2_max_unified_j1_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old base hbltu hcarry
    · exact divK_loop_body_n2_max_unified_j2_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old base hbltu hcarry
  · -- true (call)
    ...
    fin_cases j
    · exact divK_loop_body_n2_call_unified_j0_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old ret_mem d_mem dlo_mem scratch_un0 base halign hbltu hcarry
    · exact divK_loop_body_n2_call_unified_j1_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old ret_mem d_mem dlo_mem scratch_un0 base halign hbltu hcarry
    · exact divK_loop_body_n2_call_unified_j2_spec_within sp j_old v5_old v6_old v7_old v10_old v11_old v2_old
        v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old ret_mem d_mem dlo_mem scratch_un0 base halign hbltu hcarry
...
theorem divK_loop_body_n2_max_unified_j2_spec
    ...
    cpsTriple (base + loopBodyOff) (base + loopBodyOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (2 : Word)) **
       ...
       (qAddr ↦ₘ qOld))
      (loopIterPostN2Max sp (2 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_max_unified_j2_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld base hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n2_max_unified_j1_spec
    ...
    cpsTriple (base + loopBodyOff) (base + loopBodyOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (1 : Word)) **
       ...
       (qAddr ↦ₘ qOld))
      (loopIterPostN2Max sp (1 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_max_unified_j1_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld base hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n2_max_unified_j0_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (0 : Word)) **
       ...
       (qAddr ↦ₘ qOld))
      (loopIterPostN2Max sp (0 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_max_unified_j0_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld base hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n2_call_unified_j2_spec
    ...
    cpsTriple (base + loopBodyOff) (base + loopBodyOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (2 : Word)) **
       ...
       (sp + signExtend12 3944 ↦ₘ scratch_un0))
      (loopIterPostN2Call sp base (2 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_call_unified_j2_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld retMem dMem dloMem scratch_un0 base halign hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n2_call_unified_j1_spec
    ...
    cpsTriple (base + loopBodyOff) (base + loopBodyOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (1 : Word)) **
       ...
       (sp + signExtend12 3944 ↦ₘ scratch_un0))
      (loopIterPostN2Call sp base (1 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_call_unified_j1_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld retMem dMem dloMem scratch_un0 base halign hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_body_n2_call_unified_j0_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      ((.x12 ↦ᵣ sp) ** (.x1 ↦ᵣ (0 : Word)) **
       ...
       (sp + signExtend12 3944 ↦ₘ scratch_un0))
      (loopIterPostN2Call sp base (0 : Word) v0 v1 v2 v3 u0 u1 u2 u3 uTop) := by
  exact (divK_loop_body_n2_call_unified_j0_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop qOld retMem dMem dloMem scratch_un0 base halign hbltu hcarry2_nz).to_cpsTriple
...
theorem divK_loop_n2_max_max_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN2Iter10Pre sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
        v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig q1Old q0Old)
      (loopN2MaxPost sp v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig) := by
  exact (divK_loop_n2_max_max_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig q1Old q0Old base hbltu_1 hbltu_0 hcarry2).to_cpsTriple
...
theorem divK_loop_n2_call_call_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN2Iter10PreWithScratch sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
        ...
        retMem dMem dloMem scratch_un0)
      (loopN2CallCallPost sp base v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig) := by
  exact (divK_loop_n2_call_call_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig q1Old q0Old retMem dMem dloMem scratch_un0 base halign hbltu_1 hbltu_0 hcarry2).to_cpsTriple
...
theorem divK_loop_n2_max_call_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN2Iter10PreWithScratch sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
        ...
        retMem dMem dloMem scratch_un0)
      (loopN2MaxCallPost sp base v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig) := by
  exact (divK_loop_n2_max_call_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig q1Old q0Old retMem dMem dloMem scratch_un0 base halign hbltu_1 hbltu_0 hcarry2).to_cpsTriple
...
theorem divK_loop_n2_call_max_spec
    ...
    cpsTriple (base + loopBodyOff) (base + denormOff) (sharedDivModCode base)
      (loopN2Iter10PreWithScratch sp jOld v5Old v6Old v7Old v10Old v11Old v2Old
        ...
        retMem dMem dloMem scratch_un0)
      (loopN2CallMaxPost sp base v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig) := by
  exact (divK_loop_n2_call_max_spec_within sp jOld v5Old v6Old v7Old v10Old v11Old v2Old v0 v1 v2 v3 u0 u1 u2 u3 uTop u0Orig q1Old q0Old retMem dMem dloMem scratch_un0 base halign hbltu_1 hbltu_0 hcarry2).to_cpsTriple
    ...
    cpsTriple (base + loopBodyOff) exit_addr (sharedDivModCode base)
      (match bltu with
       ...
       | false => loopBodyPre (2 : Word) sp (j.val : Word) j_old
                    ...
                    v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old)
      (loopIterPostN2 bltu sp base (j.val : Word) v0 v1 v2 v3 u0 u1 u2 u3 u_top) := by
  exact (divK_loop_body_n2_iter_spec_within j bltu sp j_old v5_old v6_old v7_old v10_old v11_old v2_old v0 v1 v2 v3 u0 u1 u2 u3 u_top q_old ret_mem d_mem dlo_mem scratch_un0 base halign hbltu hcarry).to_cpsTriple
