/-
  ...
  Shared CodeReq composition infrastructure for the corrected two-MUL and
  whole-code saved-bit EXP layouts.  Shared names and the single-offset
  iteration decomposition live in sibling modules.
-/
