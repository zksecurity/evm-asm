/-
  ...
  Boundary-block pointer-restore and epilogue helpers for the corrected
  two-MUL saved-bit EXP code bundle. Prologue helpers live in
  SavedBitBoundaryPrologue.
-/
