...
theorem evm_or_spec (sp base : Addr)
  ...
  have L0 := or_limb_spec 0 32 sp a0 b0 v7 v6 base hv0 hv32
  have L1 := or_limb_spec 8 40 sp a1 b1 (a0 ||| b0) b0 (base + 16) hv8 hv40
  have L2 := or_limb_spec 16 48 sp a2 b2 (a1 ||| b1) b1 (base + 32) hv16 hv48
  have L3 := or_limb_spec 24 56 sp a3 b3 (a2 ||| b2) b2 (base + 48) hv24 hv56
