...
theorem sub_limb_carry_spec_phase2 (offB : BitVec 12)
    (sp temp b_limb borrowIn borrow1 a_limb : Word) (memA : Word) (base : Word) :
    let memB := sp + signExtend12 offB
...
theorem sub_limb_carry_spec (offA offB : BitVec 12)
  ...
  have p1 := sub_limb_carry_spec_phase1 offA offB sp a_limb b_limb v7 v6 borrowIn v11 base
  have p2 := sub_limb_carry_spec_phase2 offB sp (a_limb - b_limb) b_limb borrowIn
