...
/-- Code requirement for the 256-bit EVM XOR operation (RV32). -/
abbrev evm_xor_code (base : Addr) : CodeReq :=
  ...
  (CodeReq.union (CodeReq.singleton (base + 24) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 40) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 56) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 72) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 88) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 104) (.XOR .x7 .x7 .x6))
  ...
  (CodeReq.union (CodeReq.singleton (base + 120) (.XOR .x7 .x7 .x6))
