...
theorem evm_or_spec (sp base : Addr)
  ...
  have L0 := or_limb_spec 0 32 sp a0 b0 v7 v6 base hvm0 hvm32
  have L1 := or_limb_spec 4 36 sp a1 b1 (a0 ||| b0) b0 (base + 16) hvm4 hvm36
  have L2 := or_limb_spec 8 40 sp a2 b2 (a1 ||| b1) b1 (base + 32) hvm8 hvm40
  have L3 := or_limb_spec 12 44 sp a3 b3 (a2 ||| b2) b2 (base + 48) hvm12 hvm44
  have L4 := or_limb_spec 16 48 sp a4 b4 (a3 ||| b3) b3 (base + 64) hvm16 hvm48
  have L5 := or_limb_spec 20 52 sp a5 b5 (a4 ||| b4) b4 (base + 80) hvm20 hvm52
  have L6 := or_limb_spec 24 56 sp a6 b6 (a5 ||| b5) b5 (base + 96) hvm24 hvm56
  have L7 := or_limb_spec 28 60 sp a7 b7 (a6 ||| b6) b6 (base + 112) hvm28 hvm60
