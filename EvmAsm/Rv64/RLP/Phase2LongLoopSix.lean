...
theorem rlp_phase2_long_loop_six_byte_spec
    ...
    cpsTriple base (base + 24)
      ...
      (rlp_phase2_long_loop_six_byte_post len ptr
        ...
        ((extractByte wordVal (byteOffset (ptr + 5))).zeroExtend 64)
        wordVal dwordAddr) :=
  (rlp_phase2_long_loop_six_byte_spec_within len ptr v12Old wordVal dwordAddr
    base back halign1 halign2 halign3 halign4 halign5 halign6 hvalid1 hvalid2
    hvalid3 hvalid4 hvalid5 hvalid6 hback).to_cpsTriple
