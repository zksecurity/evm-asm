...
theorem rlp_phase1_cascade_prefix_e3_spec (v5 v10 : Word)
  ...
  (rlp_phase1_cascade_prefix_e3_spec_within v5 v10 off1 off2 off3 base e3_target
    htarget hv5_lo hv5_mid hv5_hi hd12 hd13 hd23).to_cpsTriple
...
theorem rlp_phase1_cascade_prefix_e3_spec' (v5 v10 : Word)
    ...
    cpsTriple base e3_target
      ...
      ((.x5 ↦ᵣ v5) ** (.x0 ↦ᵣ (0 : Word)) ** (.x10 ↦ᵣ v10))
      ((.x5 ↦ᵣ v5) ** (.x0 ↦ᵣ (0 : Word)) ** (.x10 ↦ᵣ kVal3)) :=
  (rlp_phase1_cascade_prefix_e3_spec'_within v5 v10 off1 off2 off3 base
    e3_target htarget hv5_lo hv5_mid hv5_hi).to_cpsTriple
