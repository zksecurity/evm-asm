...
theorem rlp_phase1_cascade_prefix_e5_spec (v5 v10 : Word)
  ...
  have step3 := rlp_phase1_step_ntaken_spec v5
  ...
  have step4 := rlp_phase1_step_ntaken_spec v5
  ...
  have step34 := cpsTriple_seq hd34 step3 step4
  ...
  have step234 := cpsTriple_seq hd2_34 step2 step34
