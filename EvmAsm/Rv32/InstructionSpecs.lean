/-
  ...
  Each spec uses CodeReq.singleton as the code side-condition, which replaces
  the old linear instrAt resource in P/Q.
...
theorem add_spec (rd rs1 rs2 : Reg) (v1 v2 v_old : Word) (base : Addr)
    ...
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADD rd rs1 rs2))
...
theorem add_spec_rd_eq_rs1 (rd rs2 : Reg) (v1 v2 : Word) (base : Addr)
    ...
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADD rd rd rs2))
      ((rd ↦ᵣ v1) ** (rs2 ↦ᵣ v2))
      ((rd ↦ᵣ (v1 + v2)) ** (rs2 ↦ᵣ v2)) :=
...
theorem add_spec_rd_eq_rs2 (rd rs1 : Reg) (v1 v2 : Word) (base : Addr)
    ...
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADD rd rs1 rd))
      ((rs1 ↦ᵣ v1) ** (rd ↦ᵣ v2))
      ((rs1 ↦ᵣ v1) ** (rd ↦ᵣ (v1 + v2))) :=
...
theorem add_spec_all_same (rd : Reg) (v : Word) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADD rd rd rd))
      (rd ↦ᵣ v)
      (rd ↦ᵣ (v + v)) :=
...
theorem sub_spec (rd rs1 rs2 : Reg) (v1 v2 v_old : Word) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.SUB rd rs1 rs2))
      ((rs1 ↦ᵣ v1) ** (rs2 ↦ᵣ v2) ** (rd ↦ᵣ v_old))
      ((rs1 ↦ᵣ v1) ** (rs2 ↦ᵣ v2) ** (rd ↦ᵣ (v1 - v2))) :=
...
theorem sub_spec_rd_eq_rs1 (rd rs2 : Reg) (v1 v2 : Word) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.SUB rd rd rs2))
      ((rd ↦ᵣ v1) ** (rs2 ↦ᵣ v2))
      ((rd ↦ᵣ (v1 - v2)) ** (rs2 ↦ᵣ v2)) :=
...
theorem addi_spec (rd rs1 : Reg) (v1 v_old : Word) (imm : BitVec 12) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADDI rd rs1 imm))
      ((rs1 ↦ᵣ v1) ** (rd ↦ᵣ v_old))
...
theorem addi_spec_same (rd : Reg) (v : Word) (imm : BitVec 12) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.ADDI rd rd imm))
      (rd ↦ᵣ v)
...
theorem lui_spec (rd : Reg) (v_old : Word) (imm : BitVec 20) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.LUI rd imm))
      (rd ↦ᵣ v_old)
      (rd ↦ᵣ ((imm.zeroExtend 32 : Word) <<< 12)) :=
...
theorem auipc_spec (rd : Reg) (v_old : Word) (imm : BitVec 20) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.AUIPC rd imm))
      (rd ↦ᵣ v_old)
      (rd ↦ᵣ (base + ((imm.zeroExtend 32 : Word) <<< 12))) :=
...
theorem lw_spec (rd rs1 : Reg) (v_addr v_old mem_val : Word) (offset : BitVec 12) (base : Addr)
  ...
  generic_lw_spec rd rs1 v_addr v_old mem_val offset base hrd_ne_x0 hvalid
...
theorem lw_spec_same (rd : Reg) (v_addr mem_val : Word) (offset : BitVec 12) (base : Addr)
    ...
    (hvalid : isValidMemAccess (v_addr + signExtend12 offset) = true) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.LW rd rd offset))
      ((rd ↦ᵣ v_addr) ** ((v_addr + signExtend12 offset) ↦ₘ mem_val))
      ((rd ↦ᵣ mem_val) ** ((v_addr + signExtend12 offset) ↦ₘ mem_val)) := by
  intro R hR s hcr hPR hpc; subst hpc
  have hfetch : s.code s.pc = some (.LW rd rd offset) :=
    (CodeReq.singleton_satisfiedBy s.pc (.LW rd rd offset) s).mp hcr
  ...
  have hmem : s.getMem (v_addr + signExtend12 offset) = mem_val :=
    (holdsFor_memIs _ _ s).mp (holdsFor_sepConj_elim_right
      (holdsFor_sepConj_elim_left hPR))
  have hstep' : step s = some (execInstrBr s (.LW rd rd offset)) :=
    step_lw s rd rd offset hfetch (hrd ▸ hvalid)
  have hexec' : execInstrBr s (.LW rd rd offset) = (s.setReg rd mem_val).setPC (s.pc + 4) := by
  ...
  · have h1 := holdsFor_sepConj_assoc.mp hPR
    ...
    exact holdsFor_pcFree_setPC (pcFree_sepConj (pcFree_sepConj (pcFree_regIs rd mem_val) (pcFree_memIs _ _)) hR) _ _ h3
...
theorem sw_spec (rs1 rs2 : Reg) (v_addr v_data mem_old : Word) (offset : BitVec 12) (base : Addr)
  ...
  generic_sw_spec rs1 rs2 v_addr v_data mem_old offset base hvalid
...
theorem sw_spec_same (rs : Reg) (v : Word) (mem_old : Word) (offset : BitVec 12) (base : Addr)
    ...
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.SW rs rs offset))
      ((rs ↦ᵣ v) ** ((v + signExtend12 offset) ↦ₘ mem_old))
      ((rs ↦ᵣ v) ** ((v + signExtend12 offset) ↦ₘ v)) := by
  intro R hR s hcr hPR hpc; subst hpc
  have hfetch : s.code s.pc = some (.SW rs rs offset) :=
    (CodeReq.singleton_satisfiedBy s.pc (.SW rs rs offset) s).mp hcr
  have hrs : s.getReg rs = v :=
    (holdsFor_regIs _ _ s).mp (holdsFor_sepConj_elim_left
      (holdsFor_sepConj_elim_left hPR))
  have hstep' : step s = some (execInstrBr s (.SW rs rs offset)) :=
    step_sw s rs rs offset hfetch (hrs ▸ hvalid)
  have hexec' : execInstrBr s (.SW rs rs offset) =
  ...
  · have h1 := holdsFor_sepConj_pull_second.mp hPR
    ...
    exact holdsFor_pcFree_setPC (pcFree_sepConj (pcFree_sepConj (pcFree_regIs rs v) (pcFree_memIs _ _)) hR) _ _ h3
...
theorem beq_spec_same (rs : Reg) (offset : BitVec 13) (v : Word) (base : Addr) :
    cpsBranch base
      (CodeReq.singleton base (.BEQ rs rs offset))
      (rs ↦ᵣ v)
  ...
  · show (step s).bind (stepN 0) = some _
    rw [hstep', hexec']; rfl
  · exact holdsFor_pcFree_setPC (pcFree_sepConj (pcFree_regIs rs v) hR) _ _ hPR
...
theorem bne_spec_same (rs : Reg) (offset : BitVec 13) (v : Word) (base : Addr) :
    cpsBranch base
      (CodeReq.singleton base (.BNE rs rs offset))
      (rs ↦ᵣ v)
      (base + signExtend13 offset) (rs ↦ᵣ v)
      (base + 4) (rs ↦ᵣ v) := by
  intro R hR s hcr hPR hpc; subst hpc
...
theorem jalr_spec_same (rd : Reg) (v : Word) (offset : BitVec 12) (base : Addr)
    ...
    cpsTriple base ((v + signExtend12 offset) &&& (~~~1))
      (CodeReq.singleton base (.JALR rd rd offset))
      (rd ↦ᵣ v)
      (rd ↦ᵣ (base + 4)) := by
  intro R hR s hcr hPR hpc; subst hpc
...
theorem mv_spec (rd rs : Reg) (v v_old : Word) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.MV rd rs))
      ((rs ↦ᵣ v) ** (rd ↦ᵣ v_old))
      ((rs ↦ᵣ v) ** (rd ↦ᵣ v)) :=
...
theorem li_spec (rd : Reg) (v_old imm : Word) (base : Addr)
    (hrd_ne_x0 : rd ≠ .x0) :
    cpsTriple base (base + 4)
      (CodeReq.singleton base (.LI rd imm))
      (rd ↦ᵣ v_old)
      (rd ↦ᵣ imm) :=
...
/-!
  ...
  All specs use CodeReq.singleton as the code side-condition instead of the
  linear instrAt resource. This means code is no longer consumed by proofs.
-/
